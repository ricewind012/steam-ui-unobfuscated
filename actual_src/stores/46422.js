...
class Qe {
	...
	async InitWithoutUser() {
		OverlayStore.RegisterForBrowserCreated(this.OnOverlayBrowserCreated);
		OverlayStore.RegisterForBrowserClosed(this.OnOverlayBrowserClosed);
		OverlayStore.RegisterForBrowserUpdated(this.OnOverlayBrowserUpdated);
		OverlayStore.RegisterForNotificationPositionChanged(
