...
export const g5 = 250820;
export const lm = 330050;
export const JP = 358510;
export const wK = 366490;
export const IV = 413080;
export const s5 = 413090;
export const qh = 443510;
export const mZ = 1;
export const oe = 2371090;
export function ak(e) {
	return e == g5 || e == lm;
}
export function wr(e) {
	return e == IV || e == s5 || e == qh || e == qx;
}
export const kF = "18446744073709551615";
export const ME = 0;
export const TQ = 2147483647;
export function ww(e, t = "en") {
	switch (e) {
		case 0:
			return "en";
		case 1:
...
export const x6 = (e) => (e === "koreana" ? "korean" : e);
export function Lg(e, t = "") {
	switch (e) {
		case 0:
			return "english";
		case 1:
...
(function (e) {
	...
	e[(e.k_EAppUpdateContentType_Shader = 2)] = "k_EAppUpdateContentType_Shader";
	e[(e.k_EAppUpdateContentType_Max = 3)] = "k_EAppUpdateContentType_Max";
})(($6 ||= {}));
(function (e) {
	...
	e[(e.k_EAppUpdateProgress_Download = 2)] = "k_EAppUpdateProgress_Download";
	e[(e.k_EAppUpdateProgress_Staging = 3)] = "k_EAppUpdateProgress_Staging";
	e[(e.k_EAppUpdateProgress_VerifyingStagedFiles = 4)] =
		"k_EAppUpdateProgress_VerifyingStagedFiles";
	e[(e.k_EAppUpdateProgress_Copying = 5)] = "k_EAppUpdateProgress_Copying";
...
(function (e) {
	...
	e[(e.k_EGamingDeviceType_StandardPC = 1)] = "k_EGamingDeviceType_StandardPC";
	e[(e.k_EGamingDeviceType_Console = 256)] = "k_EGamingDeviceType_Console";
	e[(e.k_EGamingDeviceType_PS3 = 272)] = "k_EGamingDeviceType_PS3";
	e[(e.k_EGamingDeviceType_Steambox = 288)] = "k_EGamingDeviceType_Steambox";
	e[(e.k_EGamingDeviceType_Tesla = 320)] = "k_EGamingDeviceType_Tesla";
	e[(e.k_EGamingDeviceType_Handheld = 512)] = "k_EGamingDeviceType_Handheld";
	e[(e.k_EGamingDeviceType_Phone = 528)] = "k_EGamingDeviceType_Phone";
	e[(e.k_EGamingDeviceType_SteamDeck = 544)] = "k_EGamingDeviceType_SteamDeck";
})((zm ||= {}));
(function (e) {
...
(function (e) {
	...
	e[(e.k_EAppReleaseState_Unavailable = 1)] = "k_EAppReleaseState_Unavailable";
	e[(e.k_EAppReleaseState_Prerelease = 2)] = "k_EAppReleaseState_Prerelease";
	e[(e.k_EAppReleaseState_PreloadOnly = 3)] = "k_EAppReleaseState_PreloadOnly";
	e[(e.k_EAppReleaseState_Released = 4)] = "k_EAppReleaseState_Released";
	e[(e.k_EAppReleaseState_Disabled = 5)] = "k_EAppReleaseState_Disabled";
})((lc ||= {}));
(function (e) {
...
(function (e) {
	e[(e.k_EWindowBringToFrontInvalid = 0)] = "k_EWindowBringToFrontInvalid";
