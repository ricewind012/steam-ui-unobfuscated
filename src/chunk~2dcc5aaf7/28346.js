	...
	const t = [
		{
			eID: 8,
			sIcon: g,
			sLoc: "#AppDetails_Feature_MultiPlayer",
		},
		{
			eID: 7,
			sIcon: h,
			sLoc: "#AppDetails_Feature_SinglePlayer",
		},
		{
			eID: 9,
			sIcon: p,
			sLoc: "#AppDetails_Feature_CoOp",
		},
		{
			eID: 6,
			sIcon: d,
			sLoc: "#AppDetails_Feature_SteamAchievements",
		},
		{
			eID: 10,
			sIcon: A,
			sLoc: "#AppDetails_Feature_SteamCloud",
		},
		{
			eID: 1,
			svg: u.ControllerStatus,
			sLoc: "#AppDetails_Feature_FullController",
		},
		{
			eID: 2,
			svg: (e) =>
		...
		},
		{
			eID: 5,
			sIcon: C,
			sLoc: "#AppDetails_Feature_SteamWorkshop",
		},
		{
			eID: 3,
			svg: m.VR,
			sLoc: "#AppDetails_Feature_VRSupport",
		},
		{
			eID: 11,
			sIcon: _,
			sLoc: "#AppDetails_Feature_RemotePlayTogether",
		},
		{
			eID: 16,
			svg: (e) =>
...
export class n$ extends n.Component {
	render() {
		if (!zX(this.props.overview, this.props.feature)) {
			return null;
		}
