...
export function CY(e) {
	...
	return n.createElement(i.aZ, {
		upperDescription: r,
		title: (0, a.we)(t.timezoneLocalizationToken),
		description: (0, a.we)(t.regionsLocalizationToken),
	});
}
function p() {
	...
	return n.createElement(m.C, {
		feature: u.uX,
		label: (0, a.we)("#Settings_TimeAndDate_24HourClock"),
...
export function tm() {
	...
	return n.createElement(
		...
		e &&
			n.createElement(c.B, {
				feature: 7,
				label: (0, a.we)("#Settings_TimeAndDate_Timezone"),
				rgOptions: i,
				selectedOption: t,
				onChange: (e) => {
					t = e.data;
