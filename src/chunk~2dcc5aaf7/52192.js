...
export function VF(e) {
	...
	let p = w[r];
	if (c == 6 || c == 7) {
		p = c == 6 ? a.g4.LeftTrigger : a.g4.RightTrigger;
		A = i.TriggerBinding;
	}
	const g = t ?? 4;
	const h = s.k$[l]?.id + "_" + s.SW[r]?.id;
	const C = (0, u.A)(A, m ? i.SmallGlyphIcon : i.MediumGlyphIcon);
	const _ = (function (e, t, r) {
		const n = V(e, t, r);
		return n && n?.strPath != null && Uq(n?.strPath);
	})(c, r, g);
	const f = p != null || _;
	const b = (!f || s.z_[h]?.verbose == 1) && !d;
	const y = (0, u.A)(
		m ? i.ShrinkList : undefined,
...
export function JD(e, t, r) {
	...
	if (a != null && a.playerNumber) {
		...
		if (a != null && e?.action !== undefined && e.led_color !== undefined) {
			const t = (0, b.E)(e.led_color);
			return n.createElement(
				"div",
				{
					className: i.LEDColorButtonContents,
				},
				n.createElement(y.IFd, {
...
export function Po() {
	...
	const n = r == null ? undefined : r.layers[t];
	const i = (0, s.U$)(r, 2);
	const a = (0, s.U$)(n, 2);
	return i.length > 0 || a.length > 0;
}
export function sn(e, t) {
	return s.Ou[t] != null && ((0, s.mJ)(e) & s.Ou[t]) != 0;
}
...
export function nQ(e, t) {
	return (
		...
		Number((0, s.mJ)(e) & s.SW[t]?.controller_filter) == 0
	);
}
...
export function im(e, t) {
	return (
		(!s.SW[t]?.subheader_filter ||
			Number((0, s.mJ)(e) & s.SW[t]?.subheader_filter) != 0) &&
		!!s.SW[t] &&
...
export function hq(e, t, r) {
	return (
		...
		((Number((1 << t) & s.KU.k_EInputSource_Trackpads) != 0 ||
			...
			((Number((0, s.mJ)(e) & s.RL.k_EControllerTypeFlags_Trackpad) != 0 &&
				Number((1 << t) & s.KU.k_EInputSource_Trackpads) != 0) ||
				(Number(
					(0, s.mJ)(e) &
...
export const UT = (0, A.PA)((e) => {
	const {
		controllerType: t,
		controllerSource: r,
		controllerModeInput: a,
		className: o,
		knockout: l,
		controllerDigitalIO: c,
		...m
	} = e;
	let d = null;
	if (c != null) {
		const e = (0, s.r8)(c);
		d = V(e?.eSource, e?.eInputMode, t, l);
	} else {
		d = V(r, a, t, l);
	}
	console.assert(d, "Couldn't generate controller glyph for ", t, r, a);
...
export function x1(e) {
	...
	let t = e * 2;
	t = t > 2 ? -Math.pow(4 - t, 4) - 1 : Math.pow(t, 4);
	return t;
}
...
export function rw(e, t) {
	switch (e) {
		case 11:
			return n.createElement(m.TouchMenu, {
				className: t,
			});
		case 14:
			return n.createElement(m.RadialMenu, {
				className: t,
			});
		case 19:
			return n.createElement(m.HotbarMenu, {
				className: t,
			});
		case 18:
			return n.createElement(m.SteamInputModeScroll2D, {
				className: t,
			});
		case 9:
			return n.createElement(m.SteamInputModeScrollWheel, {
				className: t,
			});
		case 4:
		case 7:
		...
		case 22:
		case 13:
			return n.createElement(m.Mouse, {
				className: t,
			});
		case 12:
		case 6:
		...
		case 3:
		case 10:
			return n.createElement(m.GuideButton, {
				className: t,
			});
		case 15:
			return n.createElement(m.TouchTap, {
				className: t,
			});
	}
}
