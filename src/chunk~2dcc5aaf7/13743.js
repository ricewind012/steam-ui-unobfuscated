...
export function $m(e) {
	...
	switch (e.button) {
		case s.g4.A: {
			return <A bIsKnockout={r} className={t} />;
		}
		case s.g4.B: {
			return <P_1 bIsKnockout={r} className={t} />;
		}
		case s.g4.X: {
			return <G_1 bIsKnockout={r} className={t} />;
		}
		case s.g4.Y: {
			return <H bIsKnockout={r} className={t} />;
		}
		case s.g4.Left: {
			return <F_1 bIsKnockout={r} className={t} />;
		}
		case s.g4.Right: {
			return <B_1 bIsKnockout={r} className={t} />;
		}
		case s.g4.Up: {
			return <C bIsKnockout={r} className={t} />;
		}
		case s.g4.Down: {
			return <_ bIsKnockout={r} className={t} />;
		}
		case s.g4.HomeMenu: {
			return <Y bIsKnockout={r} className={t} />;
		}
		case s.g4.QuickMenu: {
			return <S bIsKnockout={r} className={t} />;
		}
		case s.g4.Select: {
			return <W bIsKnockout={r} className={t} />;
		}
		case s.g4.Start: {
			return <B bIsKnockout={r} className={t} />;
		}
		case s.g4.LeftBumper: {
			return <V bIsKnockout={r} className={t} />;
		}
		case s.g4.RightBumper: {
			return <I bIsKnockout={r} className={t} />;
		}
		case s.g4.LeftTrigger: {
			return <E bIsKnockout={r} className={t} />;
		}
		case s.g4.RightTrigger: {
			return <M bIsKnockout={r} className={t} />;
		}
		case s.g4.LeftStick: {
			return <D bIsKnockout={r} className={t} />;
		}
		case s.g4.RightStick: {
			return <K bIsKnockout={r} className={t} />;
		}
		case s.g4.LeftStickClick: {
			return <T bIsKnockout={r} className={t} />;
		}
		case s.g4.RightStickClick: {
			return <R bIsKnockout={r} className={t} />;
		}
		case s.g4.LeftTrackpad: {
			return <P bIsKnockout={r} className={t} />;
		}
		case s.g4.RightTrackpad: {
			return <Z bIsKnockout={r} className={t} />;
		}
		case s.g4.LeftTrackpadClick: {
			return <L bIsKnockout={r} className={t} />;
		}
		case s.g4.RightTrackpadClick: {
			return <X bIsKnockout={r} className={t} />;
		}
		case s.g4.RearLeftUpper: {
			return <N bIsKnockout={r} className={t} />;
		}
		case s.g4.RearRightUpper: {
			return <G bIsKnockout={r} className={t} />;
		}
		case s.g4.RearLeftLower: {
			return <F bIsKnockout={r} className={t} />;
		}
		case s.g4.RearRightLower: {
			return <O bIsKnockout={r} className={t} />;
		}
		default: {
			return <U bIsKnockout={r} className={t} />;
		}
	}
}
function A({ bIsKnockout, ...t }) {
	if (bIsKnockout) {
		return (
			<svg
	...
	if (bIsKnockout) {
		return (
			...
			>
				...
				/>
				<path fill="currentColor" d="M23.1111 0H12L17.5556 5.625L23.1111 0Z" />
				<path
					fill="currentColor"
					fillRule="evenodd"
					clipRule="evenodd"
